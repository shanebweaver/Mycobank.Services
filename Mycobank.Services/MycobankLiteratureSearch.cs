...
namespace Mycobank.Services
{
    ...
    public class MycobankLiteratureSearch : Search<MycobankLiteratureSearchField>
    {
        ...
        public MycobankLiteratureSearch(MycobankLiteratureSearchField searchField, ComparisonOperator comparisonOperator, string value, int? limit = null)
            : base(searchField, comparisonOperator, value, limit)
        {

        }

        public MycobankLiteratureSearch(MycobankLiteratureSearchField searchField, string targetTableName, string targetFieldCode, ComparisonOperator comparisonOperator, string value, int? limit = null)
            : base(searchField, comparisonOperator, value, limit)
        {
        ...
        {
            return await MycobankLiteratureService.Instance.Perform(this);
        }
    }
}
