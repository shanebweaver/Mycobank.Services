...
namespace Mycobank.Services
{
    ...
    public class MycobankSearch : Search<MycobankSearchField>
    {
        ...
        public MycobankSearch(MycobankSearchField searchField, ComparisonOperator comparisonOperator, string value, int? limit = null)
            : base(searchField, comparisonOperator, value, limit)
        {

        }

        public MycobankSearch(MycobankSearchField searchField, string targetTableName, string targetFieldCode, ComparisonOperator comparisonOperator, string value, int? limit = null)
            : base(searchField, comparisonOperator, value, limit)
        {
        ...
        {
            return await MycobankService.Instance.Perform(this);
        }
    }
}
